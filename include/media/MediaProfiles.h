...
enum camcorder_quality {
    ...
    CAMCORDER_QUALITY_1440P = 7,
    CAMCORDER_QUALITY_QVGA = 8,
    CAMCORDER_QUALITY_2160P = 9,
    ...
    CAMCORDER_QUALITY_TIME_LAPSE_1440P = 1007,
    CAMCORDER_QUALITY_TIME_LAPSE_QVGA = 1008,
    CAMCORDER_QUALITY_TIME_LAPSE_2160P = 1009,
